...
## Project Structure
    ...
    ├── brothers_building_35300  # Django project configurations
...
1. Clone this repo and `cd brothers_building_35300`
...
2. Clone this repo and `cd brothers_building_35300`
